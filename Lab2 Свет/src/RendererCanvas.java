...
public class RendererCanvas extends GLCanvas implements GLEventListener, KeyListener {
    ...
    private void prepareCylinderList(GL2 gl, float radius, float height, int listId) {
        Path texturePath = FileSystems.getDefault().getPath(RendererSetup.TEXTURES_PATH, CYLINDER_TEXTURE_FILE);
            ...
            gl.glBlendFunc(GL_SRC_ALPHA,1 -GL_SRC_ALPHA);
                  // gl.glTexGendv (GL_S, GL_EYE_PLANE, s_coeffs);
            gl.glNewList(listId, GL_COMPILE);

            glu.gluCylinder(cylinder, radius, radius, height, 80, 80);
...
*/
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        float[] light_diffuse = { 1.0f, 1.0f, 1.0f, 5.0f };
   ...
   /* включаем z-буфер */
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glGenLists(2);
        prepareCylinderList(gl, 20f, 80f, CYLINDER_LIST_ID);
        prepareConeList(gl, 0f, 0f, CONE_LIST_ID);
